	...
	<!-- 인기 음식 -->
		...
		<section id="submit-property" data-parallax-speed="0" align="center">
			...
			<sec:authorize access="!isAuthenticated()"><!-- 비회원 권한 설정 -->
					...
					<a href="#" id="loginCheck" onclick="loginCheck()" class="btn btn-defalt button-large">판매자 등록하기</a>
			</sec:authorize>
			<sec:authorize access="hasRole('ROLE_BUYER')"><!-- 구매자 권한 설정 -->
					<a href="#" onclick="registeSeller()" class="btn btn-defalt button-large">판매자 등록하기</a>
			</sec:authorize>
				</div>
			</div>
		</section>
