...
insert into review(rev_no, score, rev_postdate, rev_content, tr_no) 
values(review_seq.nextval, 5 ,sysdate, '진짜 맛있었어요 주부님짱짱 또 구매하고 싶네요~~!^^', 1);

insert into review(rev_no, score, rev_postdate, rev_content, tr_no) 
values(review_seq.nextval, 2, sysdate, '별로 제 입맛에는 맞지 않았지만 다른분들은 좋아하실수도 있겠네요', 1);

insert into review(rev_no, score, rev_postdate, rev_content, tr_no) 
values(review_seq.nextval, 4, sysdate, '다시 구매하고 싶어요!ㅇㅇ주부님 감사해요~~', 2);
